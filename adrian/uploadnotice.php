...
<html lang="en">
	<head>
		...
		<title>Adrian Loyal School | News & Notice</title>
	...
	<body>
		...
		<section class="header-section middle-wrapper" style="background-color :#07323e;height: 120px;" >
			<div class="middle-content">
				<div class="container">
					<h2 style="color : #fff;"> Welcome to Admin Panel</h2>
        ...
        <div class="container">
                <div class="row">
	                <div class="col-md-12">
    		            <h2> News Upload | <a href="news.php" target="_blank">Click to view</a></h2> 
    		            
    		            
    	            	<form action="newsupload.php" enctype="multipart/form-data" method="post">
    		
    		            <input name="dat" type="text" cols="50" placeholder="Enter the Date">  <br>
    		            
    		            <input name="title" type="text" cols="50" placeholder="Enter the Title">  <br>
    		           
    		            <textarea name="description" rows="6" cols="50" placeholder="Enter the Details"></textarea>  <br>
    		           
    		                    <input name="Upload Now" type="submit" value="Upload Notice">
